...
const updateVisibleCalendar = () => {
	...
	for (let i = 0; i < monthDay; i++) {
		...
		const isHoliday =
			(currentDate.getDate() === 1 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 2 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 8 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 9 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 15 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 16 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 22 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 23 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 29 && currentDate.getMonth() === 11) ||
			(currentDate.getDate() === 30 && currentDate.getMonth() === 11);
...
// const toggleStarIcon = (item: CalendarItem) => {
	...
	<div class="flex">
		<div class="col-span-6 w-full tableBorder">
			...
			<div class="flex justify-star items-center bg-[#ECF4F7] text-[#313131] h-[60px] relative border-2 border-b-0 border-solid border-[#cccccc]">
				<button class="left-arrow mx-2 my-auto bg-[#D9D9D9] absolute right-[3.5rem]" @click="handlePrevMonth()">
				...
				<button class="right-arrow mx-2 my-auto bg-[#D9D9D9] absolute right-[1rem]" @click="handleNextMonth()">
					<svg width="30" height="30">
				...
				>
					<div class="block w-[100%]">
						<p class="text-base mb-4">
							<!-- v-if="item.icon"  -->
							<img v-if="item.icon" :src="item.icon" alt="" class="w-6 h-6 inline-block align-text-top" /> {{ item.name }}
